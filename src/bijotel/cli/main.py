...
from bijotel.cli.cmd_cross_view import add_cross_view_subparser, cross_view_cmd
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    # bijotel cross-view (v2.13.0)
    add_cross_view_subparser(subparsers)
